const todoInput = document.getElementById('textme');
const addButton = document.getElementById('addbutton');
const lists = document.getElementById('lists');
const completedCount = document.querySelector('.completed');
const notCompletedCount = document.querySelector('.uncompleted');
...
function updateCounts() {
  ...
  notCompletedCount.textContent = `uncompleted ${notCompletedTasks.length}`;
}
